...
Local['zh-hans'].RASPBERRYPI_DIGITAL_PIN_TITLE = "D"
Local['zh-hans'].RASPBERRYPI_DIGITAL_PIN_TOOLTIP = "数字引脚";

Local['zh-hans'].RASPBERRYPI_ANALOG_PIN_TITLE = "A"
Local['zh-hans'].RASPBERRYPI_ANALOG_PIN_TOOLTIP = "模拟引脚";

Local['zh-hans'].RASPBERRYPI_PWM_PIN_TITLE = "PWM"
Local['zh-hans'].RASPBERRYPI_PWM_PIN_TOOLTIP = "PWM 引脚";

Local['zh-hans'].RASPBERRYPI_DEVICE_PIN_TOOLTIP = "内置硬件引脚";

Local['zh-hans'].RASPBERRYPI_PIN_STATUS_TOOLTIP = "GPIO 引脚状态";
...
Local['zh-hans'].RASPBERRYPI_PIN_GET_VALUE_TITLE1 = "获取引脚";
Local['zh-hans'].RASPBERRYPI_PIN_GET_VALUE_TITLE2 = "的值";
Local['zh-hans'].RASPBERRYPI_PIN_GET_VALUE_TOOLTIP = "获取引脚的值";

Local['zh-hans'].RASPBERRYPI_PIN_ON_TITLE1 = "设置引脚";
Local['zh-hans'].RASPBERRYPI_PIN_ON_TITLE2 = "为打开";
Local['zh-hans'].RASPBERRYPI_PIN_ON_TOOLTIP = "设置引脚为打开";

Local['zh-hans'].RASPBERRYPI_PIN_OFF_TITLE1 = "设置引脚";
Local['zh-hans'].RASPBERRYPI_PIN_OFF_TITLE2 = "为关闭";
Local['zh-hans'].RASPBERRYPI_PIN_OFF_TOOLTIP = "设置引脚为关闭";

Local['zh-hans'].RASPBERRYPI_PIN_IRQ_TITLE1 = "添加事件监测";
...
Local['zh-hans'].RASPBERRYPI_I2C_TITLE2 = "命令";
Local['zh-hans'].RASPBERRYPI_I2C_TITLE3 = "数据";
Local['zh-hans'].RASPBERRYPI_I2C_TOOLTIP = "读I2C";


Local['zh-hans'].RASPBERRYPI_WRITE_I2C_TITLE1 = "写I2C  地址";
Local['zh-hans'].RASPBERRYPI_WRITE_I2C_TITLE2 = "寄存器地址";
Local['zh-hans'].RASPBERRYPI_WRITE_I2C_TITLE3 = "数据";
Local['zh-hans'].RASPBERRYPI_WRITE_I2C_TOOLTIP = "写 I2C";

Local['zh-hans'].RASPBERRYPI_SPI_TITLE1 = "SPI  总线";
Local['zh-hans'].RASPBERRYPI_SPI_TITLE2 = "设备";
Local['zh-hans'].RASPBERRYPI_SPI_TOOLTIP = "Read I2C";


Local['zh-hans'].RASPBERRYPI_I2C_IS_READY_TITLE1 = "是否有I2C";
Local['zh-hans'].RASPBERRYPI_I2C_IS_READY_TOOLTIP = "检查I2C设备是否响应给定的地址。";

Local['zh-hans'].RASPBERRYPI_I2C_SCAN_TITLE1 = "扫描I2C地址";
Local['zh-hans'].RASPBERRYPI_I2C_SCAN_TOOLTIP = "扫描从0x01到0x7f所有的I2C地址，并且返回响应这些地址的列表。";

Local['zh-hans'].RASPBERRYPI_I2C_SEND_TITLE1 = "发送I2c 数据";
Local['zh-hans'].RASPBERRYPI_I2C_SEND_TITLE2 = "地址";
Local['zh-hans'].RASPBERRYPI_I2C_SEND_TOOLTIP = "在总线上发送数据。";

Local['zh-hans'].RASPBERRYPI_I2C_RECV_TITLE1 = "接收I2c 数据";
Local['zh-hans'].RASPBERRYPI_I2C_RECV_TITLE2 = "地址";
Local['zh-hans'].RASPBERRYPI_I2C_RECV_TOOLTIP = "在总线上接收数据。";

Local['zh-hans'].RASPBERRYPI_I2C_MEM_WRITE_TITLE1 = "在I2C设备的内存中写入  数据";
Local['zh-hans'].RASPBERRYPI_I2C_MEM_WRITE_TITLE2 = "地址";
Local['zh-hans'].RASPBERRYPI_I2C_MEM_WRITE_TITLE3 = "从机地址";
Local['zh-hans'].RASPBERRYPI_I2C_MEM_WRITE_TOOLTIP = "在I2C设备的内存中写入。";

Local['zh-hans'].RASPBERRYPI_I2C_MEM_READ_TITLE1 = "在I2C设备的内存中读取  数据";
...
Local['zh-hans'].RASPBERRYPI_PWM_PULSE_WIDTH_PERCENTAGE_TITLE1 = "PWM设置";
Local['zh-hans'].RASPBERRYPI_PWM_PULSE_WIDTH_PERCENTAGE_TITLE1 = "脉冲宽度的百分比为";
Local['zh-hans'].RASPBERRYPI_PWM_PULSE_WIDTH_PERCENTAGE_TITLE2 = "%";
Local['zh-hans'].RASPBERRYPI_PWM_PULSE_WIDTH_PERCENTAGE_TOOLTIP = "设置PWM脉冲宽度的百分比为(0% ~ 100%).";
