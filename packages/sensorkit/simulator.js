...
SensorKit.simulator.VibrationSwitch_get_value = function(pin) {
    pin = pin.toString();
    pin = Pin(pin);
    var value = pin.value();
    return value;
...
Simulator.interpreterFunctions['VibrationSwitch_get_value'] = {
    ...
    type: "createNativeFunction",
    func: function(pin) {
        SensorKit.simulator.VibrationSwitch_get_value(pin);
    },
}
...
SensorKit.simulator.Joystick_get_value = function(Xpin, Ypin, Btpin, pin_select) {
    Xpin = Xpin.toString();
    Ypin = Ypin.toString();
...
Simulator.interpreterFunctions['Joystick_get_value'] = {
    ...
    func: function(Xpin, Ypin, Btpin, pin_select) {
        SensorKit.simulator.Joystick_get_value(Xpin, Ypin, Btpin, pin_select);
    },
}
...
SensorKit.simulator.Joystick_get_status = function(Xpin, Ypin, Btpin) {
    Xpin = Xpin.toString();
    Ypin = Ypin.toString();
    Btpin = Btpin.toString();
    var X = ADC(Xpin);
...
Simulator.interpreterFunctions['Joystick_get_status'] = {
    ...
    func: function(Xpin, Ypin, Btpin) {
        SensorKit.simulator.Joystick_get_status(Xpin, Ypin, Btpin);
    },
}
...
SensorKit.simulator.Potentiometer_get_value = function(pin) {
    pin = pin.toString();
    var adc = ADC(pin);
    var value = adc.read();
    return value;
...
Simulator.interpreterFunctions['Potentiometer_get_value'] = {
    ...
    type: "createNativeFunction",
    func: function(pin) {
        SensorKit.simulator.Potentiometer_get_value(pin);
    },
}
...
SensorKit.simulator.SoundSensor_get_value = function(pin) {
    pin = pin.toString();
    var adc = ADC(pin);
    var value_list = [];
    for (i = 0; i = 50; i++) {
...
Simulator.interpreterFunctions['SoundSensor_get_value'] = {
    ...
    type: "createNativeFunction",
    func: function(pin) {
        SensorKit.simulator.SoundSensor_get_value(pin);
    },
}
...
SensorKit.simulator.Photoresistor_get_value = function(pin) {
    pin = pin.toString();
    var adc = ADC(pin);
    var value = adc.read();
    return value;
...
Simulator.interpreterFunctions['Photoresistor_get_value'] = {
    ...
    type: "createNativeFunction",
    func: function(pin) {
        SensorKit.simulator.Photoresistor_get_value(pin);
    },
}
...
SensorKit.simulator.TouchSwitch_get_value = function(pin) {
    pin = pin.toString();
    pin = Pin(pin);
    var value = pin.value();
    return value;
...
Simulator.interpreterFunctions['TouchSwitch_get_value'] = {
    ...
    type: "createNativeFunction",
    func: function(pin) {
        SensorKit.simulator.TouchSwitch_get_value(pin);
    },
}
...
SensorKit.simulator.UltrasonicSensor_get_value = function(trig, echo, timeout) {
...
Simulator.interpreterFunctions['UltrasonicSensor_get_value'] = {
    ...
    func: function(trig, echo, timeout) {
        SensorKit.simulator.UltrasonicSensor_get_value(trig, echo, timeout);
    },
}
...
SensorKit.simulator.DS18B20_get_value = function() {};

Simulator.interpreterFunctions['DS18B20_get_value'] = {
    name: "DS18B20_get_value",
    type: "createNativeFunction",
    func: function() {
        SensorKit.simulator.DS18B20_get_value();
    },
}
...
SensorKit.simulator.Servo_set_value = function(pin, angle) {
    pin = pin.toString();
...
Simulator.interpreterFunctions['Servo_set_value'] = {
    ...
    func: function(pin, angle) {
        SensorKit.simulator.Servo_set_value(pin, angle);
    },
}
...
SensorKit.simulator.MoistureSensor_get_value = function(pin) {
    pin = pin.toString();
    var adc = ADC(pin);
    var value = adc.read();
    return value;
...
Simulator.interpreterFunctions['MoistureSensor_get_value'] = {
    ...
    type: "createNativeFunction",
    func: function(pin) {
        SensorKit.simulator.MoistureSensor_get_value(pin);
    },
}
...
SensorKit.simulator.ADXL345_get_value = function() {};

Simulator.interpreterFunctions['ADXL345_get_value'] = {
    name: "ADXL345_get_value",
    type: "createNativeFunction",
    func: function() {
        SensorKit.simulator.ADXL345_get_value();
    },
}